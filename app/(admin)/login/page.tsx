            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-black/75 pl-10 pr-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all"
